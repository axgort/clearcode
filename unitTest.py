...
"1986-12-01","1995-12-01")']
        ...
        self.assertEqual(self.destinationDb.cursor.inserts[0], inserts[0])
        self.assertEqual(self.destinationDb.cursor.inserts[1], inserts[1])
        self.assertEqual(self.destinationDb.cursor.inserts[2], inserts[2])
